...
if(isset($_GET['del'])){
  ...
  echo "<script>
    alert('ลบข้อมูลเรียบร้อยแล้ว');
        window.location = '?file=food/order_food/food-cart';
  </script>";
}
//======================================
if(isset($_POST['update']) || isset($_POST['confirm'])){
  ...
  if(isset($_POST['confirm'])){
    echo "<script>
          window.location = '?file=food/order_food/food-confirm';
          </script>";
...
if(isset($_GET['food_id'])){              //ตรวจสอบว่าถ้ามีรายการอาหารที่เลือกเเล้ว พอกดอีกครั้งก็มไม่ให้ขึ้น
...
<br><br>
<p><a href="?file=food/food-part/index" class="btn btn-info" role="button">เลือกอาหารเพิ่ม</a>
  <table class="table table-striped table-bordered cart">
    ...
    <tbody>
      ...
      <tr >
        ...
        <td><a href="?file=food/order_food/food-cart&del=<?=$key?>" class="text-danger"><i class="fas fa-trash-alt "></i></a></td>
      </tr>
    <?php endforeach;?>
    <tr>
...
<p>&nbsp; &nbsp; <a href="?file=food/food-part/index" class="btn btn-info" role="button">กลับ</a>
