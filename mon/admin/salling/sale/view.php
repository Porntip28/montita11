  ...
  <table class="table table-striped table-bordered cart">
    ...
    <tr>
      ...
      <table>
        <tr>
          <td>
            <center><b><font color="red">*** คุณได้เลือกการชำระแบบผ่อน ***</font></b></center>
            ...
            <hr>
            <b>ราคาหมูที่ต้องผ่อนจ่าย :</b> <?=number_format($sum,2,'.',',');?><b>  บาท</b>&nbsp;&nbsp;&nbsp;&nbsp;
            <b>ผ่อนจ่ายเป็นระยะเวลา :</b> <?=$data2['month'];?> <b> เดือน</b>&nbsp;&nbsp;&nbsp;&nbsp;
            <b>ดอกเบี้ยต่อเดือน : </b><?=number_format($sale_install,2,'.',',');?>&nbsp; <b>บาท</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b>เงินชำระครั้งแรก :</b> <?=number_format($data2['down'],2,'.',',');?><b>  บาท</b>&nbsp;&nbsp;&nbsp;&nbsp;
           <b>ผ่อนเดือนละ : </b><font color="red"><?=number_format($price_all,2,'.',',');?></font><b>&nbsp;บาท</b>&nbsp;&nbsp;&nbsp;&nbsp;
           <b>กำไร : </b><font color="red"><?=number_format($Profit,2,'.',',');?></font><b>&nbsp;บาท</b>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p><p><p><a href="?file=salling/sale/index" class="btn btn-info" role="button">กลับ</a>
