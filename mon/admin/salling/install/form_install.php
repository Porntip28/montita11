...
<div class="text-center">
  ...
  <div class="" id="ord_mo" name="ordermo">
          ...
          <!-- <div class="row"> -->
            <!-- <div class="col-6">
              <label for="id">ยี่ห้อ</label>
                <input type="text" class="form-control"  placeholder="ยี่ห้อ" name="gene[]">
            </div>
           ...
           <!-- <div class="col-6">
              <label for="id">แบบ</label>
                <input type="text" class="form-control" placeholder="แบบ" name="weight[]">
            </div>
          <div class="col-3">
          ...
          <div class="col-3">
            <label for="id">สี</label>
               <input type="text"  class="form-control"  placeholder="สี" name="sex[]">
             </div> -->
...
<button type="button" class="btn btn-danger" onclick="window.location.href=' ?file=moo/order_mo/index';">ยกเลิก</button>
</center>
