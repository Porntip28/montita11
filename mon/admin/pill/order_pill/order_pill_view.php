...
<?php
  ...
  WHERE detail_order_pill.order_pill_id = :order_pill_id"); //:order_pill_idตามไอดีที่GETมา
$query1->execute([
 ...
 ?>
  <table class="table table-striped table-bordered cart">
    ...
    <tbody>
      ...
      <tr >
          <td><?=++$i;?></td>
          <td><?=$val->pill_name?></td>                            <!--ชื่ออะไหล่-->
...
<p><a href="?file=pill/order_pill/history_order_pill" class="btn btn-info" role="button">ย้อนกลับ</a>
