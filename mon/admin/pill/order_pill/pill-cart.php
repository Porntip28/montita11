...
if(isset($_GET['del'])){
  ...
  echo "<script>
    alert('ลบข้อมูลเรียบร้อยแล้ว');
        window.location = '?file=pill/order_pill/pill-cart';
  </script>";
}
//======================================
if(isset($_POST['update']) || isset($_POST['confirm'])){
  ...
  if(isset($_POST['confirm'])){
    echo "<script>
          window.location = '?file=pill/order_pill/pill-confirm';
          </script>";
...
if(isset($_GET['pill_id'])){              //ตรวจสอบว่าถ้ามีรายการอะไหล่ที่เลือกเเล้ว พอกดอีกครั้งก็มไม่ให้ขึ้น
...
<br><br>
<p><a href="?file=pill/pill-part/index" class="btn btn-info" role="button">เลือกยาเพิ่ม</a>
  <table class="table table-striped table-bordered cart">
    ...
    <tbody>
      ...
      <tr >
        ...
        <td><a href="?file=pill/order_pill/pill-cart&del=<?=$key?>" class="text-danger"><i class="fas fa-trash-alt "></i></a></td>
      </tr>
    <?php endforeach;?>
    <tr>
...
<p>&nbsp; &nbsp; <a href="?file=pill/pill-part/index" class="btn btn-info" role="button">กลับ</a>
