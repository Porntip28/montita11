<?php
if(isset($_POST['ok'])){
  $query = $db->prepare('INSERT INTO gene (gene_name)
                                    VALUES (:gene_name)');
...
<br />
<center><h4>ข้อมูลสายพันธุ์</h4></center><p>
<form method="post"  >
  <div class="form-group row">
    <label  class="col-sm-2 col-form-label col-form-label-sm">ชื่อสายพันธุ์</label>
    <div class="col-sm-10">
      <input type="text" class="form-control form-control-sm"  name="gene_name" placeholder="ชื่อ">
    </div>
  </div>
<p></p>
