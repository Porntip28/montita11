<br>
<center><h5>ข้อมูลการสั่งซื้ออาหาร</h5></center>
ฺ<br>
...
if($query->rowCount() > 0){ //ตรวจสอบว่ามีข้อมูลมากว่า 0 ไหม
  ...
  <?php  if(($row->order_status)==1) {?>
    ...
    <a  title="ลบข้อมูล"href="?file=food/order_food/delete&id=<?=$row->order_food_id?>" onclick="return confirm('คุณต้องลบจริงไหม?')"><i class="far fa-trash-alt"></i></a>
  <?php }?>
      </td>
    </tr>
    <?php
